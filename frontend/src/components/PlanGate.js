  ...
  if (compact) {
    return (
      <div
        ...
        className="inline-flex items-center gap-2 px-3 py-2 rounded-md border border-amber-500/30 bg-amber-500/10 text-amber-200 text-xs"
      >
    ...
    >
      ...
      <div className="flex-1">
        ...
        <a
          ...
          className="mt-3 inline-flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-md border border-indigo-500/40 bg-indigo-500/10 text-indigo-200 hover:bg-indigo-500/20"
        >
