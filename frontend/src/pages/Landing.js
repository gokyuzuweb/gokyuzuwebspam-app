      ...
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2.5">
          ...
          <div className="leading-tight">
            ...
            <div className="text-[9px] uppercase tracking-widest text-slate-500 mono">WHM / cPanel · v44.00.07</div>
          </div>
        </Link>
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        {sorted.length === 0 ? (
          ...
          <>
            ...
            {/* v44.00.07 — Feature comparison matrix */}
...
// v44.00.07 — Plan karşılaştırma tablosu (dönüşüm için "hangi planda ne var" netliği)
...
function Testimonials() {
  // v44.00.07 — 6 testimonial, otomatik-dönen slider (5sn per slide)
  const items = [
    {
  ...
  return (
    <section className="py-24 border-t border-slate-800/60 relative overflow-hidden" data-testid="landing-testimonials">
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        {/* v44.00.07 — Auto-rotating testimonial slider (pause on hover) */}
        <div
...
// v44.00.07 — Marketplace Trending Widget (sosyal kanıt · Landing page)
